...
function ProfileModal({ onClose, displayName, avatar, profileName }) {
  ...
  const [numberfollowers, setFollowers] = useState(0);
  const [numberfollowing, setFollowing] = useState(0);
  ...
  useEffect(() => {
    async function getProfile() {
      ...
      setFollowers(numberfollowers.length);
      setFollowing(numberfollowing.length);
    }
    getProfile();
  }, []);
  ...
  const modal = (
    ...
    >
      ...
      >
        <div id="first" className="flex flex-row items-start gap-4 mb-4">
          <div className="flex flex-col items-left">
            ...
            <div id="second" className="flex flex-row gap-4 items-start mt-4">
              <div
                id="avatar"
