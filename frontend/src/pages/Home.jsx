...
function Home() {
  return (
    <>
      <div
        id="post-button"
        className="text-[#ffffff66] text-sm select-none text-nowrap z-20 gap-8 p-0 pl-6 pr-4 h-8 items-center w-100 flex bg-gradient-to-b from-transparent to-[#1F1F1F] backdrop-blur-md rounded-2xl ring-2 ring-[#ff6600] fixed left-1/2 -translate-x-1/2 bottom-28 cursor-pointer"
      >
